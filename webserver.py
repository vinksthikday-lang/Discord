...
# Get hCaptcha keys from environment variables (set in Railway)
...
@app.route('/')
def index():
    return "KoalaHub Verification Server is running. Visit /verify/<user_id> to verify."
...
def verify():
    try:
        ...
        if result.get('success'):
            ...
            return jsonify({"success": False, "error": "hCaptcha verification failed"}), 403
